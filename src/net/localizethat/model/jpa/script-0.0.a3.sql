...
CREATE TABLE "APP"."PRODLOCALEXPATH"
(
   PRODLOCALEID int NOT NULL,
   PRODPATHID int NOT NULL,
   CONSTRAINT PRODLOCALEXPATH_PK PRIMARY KEY (PRODLOCALEID,PRODPATHID)
)
;
CREATE UNIQUE INDEX IDX_PATH_LOCALE ON "APP"."PRODLOCALEXPATH"
(
  PRODPATHID,
  PRODLOCALEID
)
;
ALTER TABLE "APP"."PRODLOCALEXPATH"
    ADD CONSTRAINT PRODLOCALE_FK
    FOREIGN KEY (PRODLOCALEID)
    REFERENCES "APP"."PRODUCTLOCALE"(ID) ON DELETE CASCADE
;
ALTER TABLE "APP"."PRODLOCALEXPATH"
    ADD CONSTRAINT PRODPATH_FK
    FOREIGN KEY (PRODPATHID)
    REFERENCES "APP"."PRODUCTPATH"(ID) ON DELETE CASCADE
;
